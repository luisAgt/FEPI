...
import com.equipo1.entities.Professor;   // Cambia Professor por la clase real
...
public class ProfessorJpaController {    // Cambia Professor por el nombre real
    ...
    public void edit(Professor entidad) throws Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public void destroy(Object id) throws Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Professor entidad = em.find(Professor.class, id);
    ...
    public Professor findProfessor(Object id) {
    ...
    private List<Professor> findProfessorEntities(boolean all, int maxResults, int firstResult) {
        EntityManager em = getEntityManager();
        try {
            String simpleName = Professor.class.getSimpleName();
