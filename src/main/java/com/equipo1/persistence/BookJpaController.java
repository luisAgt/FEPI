...
import com.equipo1.entities.Book;   // Cambia Book por la clase real
 ...
 * @author XPxTBxLLX
 */
public class BookJpaController {    // Cambia Book por el nombre real
    ...
    public void create(Book entidad) throws Exception {
    ...
    public void edit(Book entidad) throws Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public void destroy(Object id) throws Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Book entidad = em.find(Book.class, id);
