...
import com.equipo1.entities.Classroom;   // Cambia Classroom por la clase real
 ...
 * @author XPxTBxLLX
 */
public class ClassroomJpaController {    // Cambia Classroom por el nombre real
    ...
    public void create(Classroom entidad) throws Exception {
